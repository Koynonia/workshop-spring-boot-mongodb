...
import br.com.linoox.workshopmongo.dto.AuthorDTO;
import br.com.linoox.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(
				null, 
				sdf.parse("21/09/2018"), 
				"Partiu viagem", 
				"Vou viajar para São Paulo. Abraços!",
				new AuthorDTO(maria));
		Post post2 = new Post(
				null, 
				sdf.parse("23/09/2018"), 
				"Bom dia", 
				"Acordei feliz hoje!", 
				new AuthorDTO(maria));
