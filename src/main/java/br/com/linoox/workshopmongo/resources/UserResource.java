...
import br.com.linoox.workshopmongo.dto.UserDTO;
...
public class UserResource {
	...
	@RequestMapping(method = RequestMethod.POST) // também @PostMapping
	...
	@RequestMapping(value = "/{id}", method = RequestMethod.PUT) // também @PutMapping
